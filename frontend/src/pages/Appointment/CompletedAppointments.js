...
import CompletedAppointmentsReport from './Reports/CompletedAppointmentsReport';
...
function CompletedAppointments() {
    ...
    return (
        <AdminLayout>
            ...
            <CustomDataGrid data={appointments} columns={columns} searchBar={<SearchBar />} report={<CompletedAppointmentsReport data={appointments}/>} /> 
            </div>
        </AdminLayout>
    )
}
