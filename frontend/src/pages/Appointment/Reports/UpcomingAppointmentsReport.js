...
const UpcomingAppointmentsReport = ({data}) => {
    ...
    const downloadPDF = () => {
        ...
        doc.text("Upcoming Appointments Report", (pageWidth / 2), 60, { align: "center" });
        // Underline the text
        const textWidth = doc.getStringUnitWidth("Upcoming Appointments Report") * doc.internal.getFontSize() / doc.internal.scaleFactor;
        ...
        doc.save("upcoming-appointments.pdf"); //Change name accordingly
      };
...
export default UpcomingAppointmentsReport;
